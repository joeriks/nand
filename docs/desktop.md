...
Den rekursiva skanningen har ersatts av local_list_directory (en nivå, högst 200 katalogposter per sida) och local_snapshot med explicita relativa filsökvägar. Rotmappsval kontrollerar endast att mappen kan öppnas. Katalogvisning läser metadata, inte filinnehåll, och avvisar sökvägar utanför roten. Endast valda filer ingår i omläsningen varannan sekund. Gränsen 500 filer/16 MiB gäller urvalet, inte rotmappens innehåll. Utkastets localExcluded markerar avval utan att radera original eller cache. Befintliga utkast behåller sin tidigare plats och är initialt valda; detta bevarar tidigare arbete.
